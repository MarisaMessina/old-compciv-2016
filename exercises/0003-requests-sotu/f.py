import requests
sotuList = ['https://www.whitehouse.gov/the-press-office/remarks-president-barack-obama-address-joint-session-congress]', 
...
for i in range(len(sotuList)):
	resp = requests.get(sotuList[i])
	print (resp.url)
	print (len(resp.text))
